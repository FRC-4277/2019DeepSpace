...
public class MecanumDrive extends Subsystem {
	...
	public MecanumDrive(int frontLeftMotor, int backLeftMotor, int frontRightMotor, int backRightMotor) {
		...
		FRONT_LEFT_TALON.setSafetyEnabled(true);
		BACK_LEFT_TALON.setSafetyEnabled(true);
		FRONT_RIGHT_TALON.setSafetyEnabled(true);
		BACK_RIGHT_TALON.setSafetyEnabled(true);
